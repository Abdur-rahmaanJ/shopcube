...
def clean(app):
    """
    Deletes shopyo.api.db and migrations/ if present in current working directory.
    ...
    # getting app context creates the shopyo.api.db file even if it is not present
    ...
    tryrmfile(os.path.join(os.getcwd(), "shopyo.api.db"))
