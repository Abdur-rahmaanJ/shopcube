...
def add():
    ...
    if request.method == "POST" and form.validate_on_submit():
        ...
        return redirect(url_for("shopyo_ecommerce.purchase.edit", po_id=po.id))
    context = mhelp.context()
...
def add_item(po_id):
    ...
    if po.status not in ("draft",):
        ...
        return redirect(url_for("shopyo_ecommerce.purchase.edit", po_id=po_id))
...
def delete(po_id):
    ...
    if po.status not in ("draft", "cancelled"):
        ...
        return redirect(url_for("shopyo_ecommerce.purchase.dashboard"))
