...
class PurchaseOrder(PkModel):
    __tablename__ = "shopyo_ecommerce_purchase_orders"
...
class PurchaseOrderItem(PkModel):
    __tablename__ = "shopyo_ecommerce_purchase_order_items"
    purchase_order_id = db.Column(db.Integer, db.ForeignKey("shopyo_ecommerce_purchase_orders.id"), nullable=False)
