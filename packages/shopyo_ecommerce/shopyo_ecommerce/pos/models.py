...
class Transaction(db.Model):
    __tablename__ = "shopyo_ecommerce_transactions"
...
class TransactionItem(db.Model):
    __tablename__ = "shopyo_ecommerce_transaction_items"
...
class Shift(db.Model):
    __tablename__ = "shopyo_ecommerce_shifts"
    id = db.Column(db.Integer, primary_key=True)
...
class QuickKey(db.Model):
    __tablename__ = "shopyo_ecommerce_quick_keys"
    id = db.Column(db.Integer, primary_key=True)
