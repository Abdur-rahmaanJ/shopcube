...
class Order(db.Model):
    __tablename__ = "shopyo_ecommerce_orders"
...
class OrderItem(PkModel):
    __tablename__ = "shopyo_ecommerce_order_items"
    ...
    order_id = db.Column(db.Integer, db.ForeignKey("shopyo_ecommerce_orders.id"), nullable=False)
...
class BillingDetail(db.Model):
    __tablename__ = "shopyo_ecommerce_billing_details"
    ...
    order_id = db.Column(db.Integer, db.ForeignKey("shopyo_ecommerce_orders.id"))
